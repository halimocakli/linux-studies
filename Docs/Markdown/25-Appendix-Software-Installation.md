...
Sistemde yer alan "**_Linux Dersleri_**" uygulamasını kaldırmak için aşağıdaki komutu girmeniz yeterlidir.
...
Programı kurmak için; öncelikle indirdiğiniz **_.zip_** arşivini açmalısınız. Arşivi açtıktan sonra **_.dmg_** dosyasını çift tıklayarak çalıştırın. Daha sonra, karşınıza çıkan kurulum asistanı penceresinde gösterildiği gibi; uygulamanın simgesini **_"Applications"_** simgesinin üzerine sürükleyin.
